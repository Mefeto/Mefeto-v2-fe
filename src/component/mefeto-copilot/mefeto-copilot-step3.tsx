              ...
              messages: [
                {
                  role: "system",
                  content: `
                  주어진 글에 제시하는 문제 상황의 전사회적, 법적, 정책적, 또는 정치적인 근본적 원인을 분석하고 추론하여 문제의 원인에 대한 짧은 글을 써라. 
                  단 다음의 형식을 준수하여라. 
                  {
                    "title": "분석 글의 제목", 
                    "content": "분석한 내용"
                ...
                { role: "user", content: form.values.problem },
              ],
            }),
  ...
  return (
    ...
    >
      ...
      <Button
        ...
        onClick={() =>
          form.setValues({ ...form.values, cause: cardData.content })
        }
      >
        가져오기
      </Button>
  ...
  return (
    <>
      <Group position="center" mt="sm">
        {state === 1 && <Title order={4}>문제의 원인을 분석하는 중...</Title>}
      </Group>
      <Carousel
...
export default MefetoCopilotStep3;
