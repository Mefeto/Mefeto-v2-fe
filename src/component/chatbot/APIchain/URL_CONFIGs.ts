const OPENAPI_KEY = {
  encoded: process.env.REACT_APP_OPENAPI_KEY_ENCODED, //process.env.REACT_APP_OPENAPI_KEY_ENCODED,
  decoded: process.env.REACT_APP_OPENAPI_KEY_DECODED,
  법제처: process.env.REACT_APP_OPENAPI_KEY_LEGISLATION,
};
...
const URL_CONFIGs = {
  "법무부 생활법률지식 정보": {
    description:
      "생활에서 자주 접하는 생활법률(주택.상가임대차, 임금, 해고, 상속) 분야에 대해 질문/답변 형식으로 변호사가 제작한 문답지식 자료",
  ...
  "법령 목록 조회": {
    ...
    requestParams: {
      OC: {
        ...
        required: true,
        description:
          "사용자 이메일의 ID(g4c@korea.kr일경우 OC값=g4c). https://open.law.go.kr/LSO/openApi/cuAskList.do 에 OPEN API 활용 신청이 되어 있어야 함.",
      },
      target: {
        value: "law",
        required: true,
      ...
      sort: {
        ...
        required: false,
        description:
          "정렬옵션(기본 : lasc 법령오름차순) / ldes: 법령내림차순 / dasc: 공포일자 오름차순 / ddes: 공포일자 내림차순 / nasc: 공포번호 오름차순 / ndes: 공포번호 내림차순 / efasc: 시행일자 오름차순 / efdes: 시행일자 내림차순",
      },
      data: {
        value: null,
        required: false,
      ...
      rrClsCd: {
        ...
        required: false,
        description:
          "법령 제개정 종류 (300201 - 제정 / 300202 - 일부개정 / 300203 - 전부개정 / 300204 - 폐지 / 300205 - 폐지제정 / 300206 - 일괄개정 / 300207 - 일괄폐지 / 300209 - 타법개정 / 300210 - 타법폐지 / 300208 - 기타)",
      },
      nb: {
        value: null,
        required: false,
  ...
  "법령정보지식베이스 법령용어 조회 API": {
    description:
      "키워드에 대한 관련 법령 용어를 검색하고 다른 관련 용어와 법 조문간 관계 링크를 조회",
    baseURL: "https://www.law.go.kr/DRF/lawSearch.do",
    requestParams: {
      OC: {
        value: OPENAPI_KEY.법제처,
  ...
  "법령정보지식베이스 일상용어 조회 API": {
    description:
      "키워드에 대한 관련 일상 용어를 검색하고 용어간 관계 링크를 조회",
    baseURL: "https://www.law.go.kr/DRF/lawSearch.do",
    requestParams: {
      OC: {
        value: OPENAPI_KEY.법제처,
  ...
  "법령정보지식베이스 일상용어-법령용어 연계 API": {
    ...
    requestParams: {
      ...
      query: {
        ...
        required: false,
        description:
          "일상용어명에서 검색을 원하는 질의(query 또는 MST 중 하나는 반드시 입력)",
      },
      MST: {
        value: null,
        required: false,
      ...
      trmRltCd: {
        ...
        required: false,
        description:
          "용어관계(동의어 : 140301 / 반의어 : 140302 / 상위어 : 140303 / 하위어 : 140304 / 연관어 : 140305)",
      },
    },
    responseElements: {
      target: {
